        ...
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="purchase_price" id="purchase_price" value="{{ old('purchase_price') ? formatRupiahInput(old('purchase_price')) : '' }}" data-format="rupiah" placeholder="0" required
                ...
                <div>
                    ...
                    <input type="text" name="selling_price" id="selling_price" value="{{ old('selling_price') ? formatRupiahInput(old('selling_price')) : '' }}" data-format="rupiah" placeholder="0" required
                ...
                <div>
                    ...
                    <input type="number" name="min_stock" id="min_stock" value="{{ old('min_stock', 10) }}" required
