        ...
        <form action="{{ route('stores.store') }}" method="POST">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="number" name="year_established" id="year_established" value="{{ old('year_established') }}" required min="1900" max="{{ date('Y') }}"
                ...
                <div>
                    ...
                    <input type="text" name="cashier_name" id="cashier_name" value="{{ old('cashier_name') }}" required
